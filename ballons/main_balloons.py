...
oScoreDisplay = pygwidgets.Display.Text(window, (10, USABLE_WINDOW_HEIGHT +25), 'Wynik: 0', textColor=BLACK, backgroundColor=None, width=140, fontSize=24)
oStatusDisplay = pygwidgets.Display.Text(window, (180, USABLE_WINDOW_HEIGHT + 25), '', textColor=BLACK, backgroundColor=None, width=300, fontSize=24)
oStartButton = pygwidgets.TextButton(window, (WINDOW_WIDTH - 110, USABLE_WINDOW_HEIGHT + 10), 'Start')

oBalloonMgr = balloon_mgr(window, WINDOW_WIDTH, USABLE_WINDOW_HEIGHT)
playing = False
...
while True:
    ...
    if playing:
        ...
        oStatusDisplay.setValue('Przebite: ' + str(nPopped) + 'Uciekły: ' + str(nMissed) + 'Wszystkie: ' + str(N_BALLOONS))
